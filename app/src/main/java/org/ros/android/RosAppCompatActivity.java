 ...
 *
 * TODO:Copy thisFile and replace AppCompatActivity to XXXActivity and ROSXXXActivity
 */
public abstract class RosAppCompatActivity extends AppCompatActivity {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            serviceListener = new NodeMainExecutorServiceListener() {
                ...
                public void onShutdown(NodeMainExecutorService nodeMainExecutorService) {
                    ...
                    // call finish() once.
                    if (!RosAppCompatActivity.this.isFinishing()) {
                        RosAppCompatActivity.this.finish();
                    }
                }
            };
     ...
     */
    protected RosAppCompatActivity(String notificationTicker, String notificationTitle) {
     ...
     */
    protected RosAppCompatActivity(String notificationTicker, String notificationTitle, URI customMasterUri) {
        super();
     ...
     */
    protected RosAppCompatActivity(String notificationTicker, String notificationTitle, Class<?> activity, int requestCode) {
     ...
     * in custom Activity constructor {@link #RosAppCompatActivity(String, String, Class, int)}.
